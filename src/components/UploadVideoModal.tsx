...
import SingleImageInput from '@components/input/SingleImageInput.tsx';
      ...
      <div className="modal-content">
        ...
        {tab === Tab.FORM && (
          <div className="tab video-form">
            <p className="text-lg font-semibold text-gray-100">Thumbnail <span className="text-sm font-light">(automatically set if not specified)</span>
            </p>
            <SingleImageInput onChange={setThumbnailFile} className="min-w-40 max-w-80 h-30 mb-2" />

            <p className="text-lg font-semibold text-gray-100">Details</p>
            <LabelNestingInput
